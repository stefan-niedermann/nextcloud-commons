...
```groovy
implementation 'com.github.stefan-niedermann:nextcloud-commons:1.8.1'
```
...
```groovy
implementation 'com.github.stefan-niedermann.nextcloud-commons:exception:1.8.1'
```
...
```groovy
implementation 'com.github.stefan-niedermann.nextcloud-commons:sso-glide:1.8.1'
```
...
```groovy
implementation('com.github.stefan-niedermann.nextcloud-commons:markdown:1.8.1') {
