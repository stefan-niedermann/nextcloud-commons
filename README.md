...
```groovy
implementation 'com.github.stefan-niedermann:nextcloud-commons:3.0.0'
```
...
```groovy
implementation 'com.github.stefan-niedermann.nextcloud-commons:exception:3.0.0'
```
...
```groovy
implementation 'com.github.stefan-niedermann.nextcloud-commons:sso-glide:3.0.0'
```
...
```groovy
implementation('com.github.stefan-niedermann.nextcloud-commons:markdown:3.0.0') {
