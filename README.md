...
```groovy
implementation 'com.github.stefan-niedermann:nextcloud-commons:2.3.1'
```
...
```groovy
implementation 'com.github.stefan-niedermann.nextcloud-commons:exception:2.3.1'
```
...
```groovy
implementation 'com.github.stefan-niedermann.nextcloud-commons:sso-glide:2.3.1'
```
...
```groovy
implementation('com.github.stefan-niedermann.nextcloud-commons:markdown:2.3.1') {
