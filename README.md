...
```groovy
implementation 'com.github.stefan-niedermann:nextcloud-commons:1.3.0'
```
...
```groovy
implementation 'com.github.stefan-niedermann.nextcloud-commons:exception:1.3.0'
```
...
```groovy
implementation 'com.github.stefan-niedermann.nextcloud-commons:sso-glide:1.3.0'
```
