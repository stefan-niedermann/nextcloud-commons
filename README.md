...
```groovy
implementation 'com.github.stefan-niedermann:nextcloud-commons:2.1.0'
```
...
```groovy
implementation 'com.github.stefan-niedermann.nextcloud-commons:exception:2.1.0'
```
...
```groovy
implementation('com.github.stefan-niedermann.nextcloud-commons:markdown:2.1.0') {
